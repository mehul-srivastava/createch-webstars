...
<head>
    ...
    <title>CorsTech | Payment - CorsLaunch</title>
    <!--Favicon-->
...
<body class="bg-light">
            ...
            <div class="row">
                ...
                <div class="col-md-8 mt-3">
                    ...
                    <div class="pricing-cut">
                        ...
                        <h3 class="text-danger">Rs 100000.00</h3>
                    </div><br>
                    <div class="pricing">
                        <p class="text-success">Offer Price</p>
                        <h3 class="text-success">Rs 70000.00</h3>
                    </div>
                    <hr>
                    <div class="calculation">
                        <div class="text">Sub Total</div>
                        <div class="amount">Rs. 70000.00</div>
                    </div><br>
                    <div class="calculation">
                        <div class="text">Tax (18%)</div>
                        <div class="amount">Rs. 12600.00</div>
                    </div><br>
                    <div class="calculation">
                    ...
                    <div class="calculation">
                        ...
                        <div class="amount">Rs. 82600.00</div>
                    </div><br>
                    <hr>
    ...
    <input type="hidden" id="company_name" value="CorsLaunch" />
    <input type="hidden" id="amount" value="8260000" />
    <input type="hidden" id="product_desc" value="Corslaunch is a dream come true program where people will get to explore the space." />
