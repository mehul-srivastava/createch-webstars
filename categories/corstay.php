...
<head>
    ...
    <title>CorsTech | Payment - Corstay</title>
    <!--Favicon-->
...
<body class="bg-light">
            ...
            <div class="row">
                ...
                <div class="col-md-8 mt-3">
                    ...
                    <div class="pricing-cut">
                        ...
                        <h3 class="text-danger">Rs 66000.00</h3>
                    </div><br>
                    <div class="pricing">
                        <p class="text-success">Offer Price</p>
                        <h3 class="text-success">Rs 56000.00</h3>
                    </div>
                    <hr>
                    <div class="calculation">
                        <div class="text">Sub Total</div>
                        <div class="amount">Rs. 56000.00</div>
                    </div><br>
                    <div class="calculation">
                        <div class="text">Tax (18%)</div>
                        <div class="amount">Rs. 10080.00</div>
                    </div><br>
                    <div class="calculation">
                    ...
                    <div class="calculation">
                        ...
                        <div class="amount">Rs. 66080.00</div>
                    </div><br>
                    <hr>
    ...
    <input type="hidden" id="company_name" value="Corstay" />
    <input type="hidden" id="amount" value="6608000" />
    <input type="hidden" id="product_desc" value="Corstay is a program for a stay of 2 months on Mars and gain knowledge about different things" />
