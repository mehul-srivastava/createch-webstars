      ...
      <li class="nav-item">
        ...
        <div class="multi-level collapse" role="list"
          ...
          <ul class="flex-column nav">
            <li class="nav-item">
              <a class="nav-link" href="payment-details.php?category=CorsView">
                <span class="sidebar-text">CorsView</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="payment-details.php?category=CorsLaunch">
                <span class="sidebar-text">CorsLaunch</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="payment-details.php?category=Corstay">
                <span class="sidebar-text">Corstay</span>
              </a>
            </li>
          </ul>
        </div>
      </li>
       <li class="nav-item" href="./contact-queries.php">
        <a href="./contact-queries.php" class="nav-link">
          <span class="sidebar-icon">
            <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>
          </span> 
          <span class="sidebar-text">Contact Queries</span>
        </a>
      </li>
      <li class="nav-item" href="./">
